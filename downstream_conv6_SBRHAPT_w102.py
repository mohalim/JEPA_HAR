...
from training.train_downstream import train_supervised, evaluate
from utils.logging import setup_logger, log_evaluation
from utils.misc import get_classifier_param_groups, get_class_weight
...
exp_num = "conv6_e440"
ckp_num = 69   # applies if is_train = 0; for loading model checkpoint
is_train = 0
...
batch_size = 64     # 16 (636), 32 (318), 64 (159)
...
# Default value
# 030 R3
# a) wd=8.5e-3 (0.9391 / 0.8572) ckp=64     lr_decay_factor = 0.975; clf_lr = 5e-3
# b) wd=1.2e-2 (0.9272 / 0.8583) ckp=77     lr_decay_factor = 0.975
# c) wd=1e-2 (0.9337 / 0.8654) ckp=69     lr_decay_factor = 0.975; clf_lr = 5e-3 (best)
# d) wd=8.5e-3 (0.9312 / 0.8575) ckp=80     lr_decay_factor = 0.975
# e) wd=8e-3 (0.9322 / 0.8577) ckp=83       lr_decay_factor = 0.975
# f) wd=4.75e-3 (0.9324 / 0.8583) ckp=71    lr_decay_factor = 0.985
# 020 R3
...
if is_train:
    ...
    #class_weight = get_class_weight(method='inverse', dataset='SBHARPT')
