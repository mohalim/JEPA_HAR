...
checkpoint_file = 'cpt_epoch70_w102_edim256.pt'
...
if is_train:
    ...
    if not is_stage_two:
        ...
        checkpoint_clf_file = 'best_model_stage1_epoch15.pt'
...
logger = setup_logger(checkpoint_clf_dir, filename="results.log")
