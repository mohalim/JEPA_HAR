...
checkpoint_file = 'cpt_epoch100_w102_edim384.pt'
...
if is_train:
    ...
    if not is_stage_two:
        ...
        checkpoint_clf_file = 'best_model_stage1_epoch83.pt'
    ...
    history = train_supervised(classifier_model, train_loader, val_loader,
                               ...
                               early_stop_metric=early_stop_metric, stage_two=is_stage_two)
...
if is_train:
    ...
    best_checkpoint = f'best_model_stage{stageNo}_epoch83.pt'
